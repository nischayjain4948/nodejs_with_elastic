...
app.post('/v1/webinar/schedule_webinar', async (req, res, next) => {
    ...
    async (req, res) => {
        ...
        let { title, description, qa = false, registration = false, record = false, password, startDate, endDate = {h:'', m: 15}, hostIds, email, edit = false } = req.body;
        ...
        try {
          ...
          const body = {title, description, qa, record , registration, password,startDate,endDate,roomId,email,userName,hostIds,createdAt}
