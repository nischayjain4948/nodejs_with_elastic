...
export const RegisterWebinar = () => {
  ...
  const getData = async () => {
    ...
    if (result.status === 200) {
      ...
      setResponse("webinar registered successfully!");
    } else {
        ...
        <form onSubmit={formHandler}>
          <div className="form-group row">
            ...
            <div className="col-sm-10">
              <input
                ...
                onChange={webinarTitleHandler}
                value={webinar_title}
                required
              />
              <br />
              {webinar_title_error ? (
                <p className="text-danger">Please fill the webinar title Minimum length 15 </p>
              ) : (
                ""
              )}
              <br />
          ...
          <div className="btn-group" role="group" aria-label="Basic checkbox toggle button group">
            ...
            <input
              ...
              id="btncheck3"
              autoComplete="off"
              value="webinar_recording"
              checked={webinar_recording}
              onChange={() => setWebinarRecoring(!webinar_recording)}
            />
          ...
          <div className="form-group row">
            ...
            <div className="col-sm-10">
              ...
              <br />
              {password_error ? (
                <p className="text-danger">Please fill the password field One letter capital min 6 length</p>
              ) : (
                ""
              )}
            </div>
          ...
          <div className="form-group row">
            ...
            <div className="col-sm-10">
              ...
              <br />
              {start_date_error ? (
                <p className="text-danger">Date and time Must be grethar than current Date and time </p>
              ) : (
                ""
              )}
            </div>
